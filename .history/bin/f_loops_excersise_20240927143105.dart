...
// Sum of Digits of a Number:
  ...
  int number = 12345; // Set the number directly
  int sum = 0; // Variable to store the sum of the digits
  String numStr =
      number.toString(); // Convert the number to a string for easy iteration

  // Use a for loop to iterate over each digit in the string
  for (int i = 0; i < numStr.length; i++) {
    sum += int.parse(numStr[
        i]); // Convert each character back to an integer and add to the sum
  }
