...
//  //Basic Switch Case:
  ...
  // bool value1 = stdin.readLineSync()!.toLowerCase() == 'true';

  // print("Enter a bool 2 : ");
  // bool value2 = stdin.readLineSync()!.toLowerCase() == 'true';

  // print("Enter a logical operator (AND, OR): ");
  // String operator = stdin.readLineSync()!.toUpperCase();
  // bool result;

  // switch (operator) {
  //   case 'AND':
  //     result = value1 && value2;
  //     print("Result of $value1 AND $value2: $result");
  //     break;
  //   case 'OR':
  //     result = value1 || value2;
  //     print("Result of $value1 OR $value2: $result");
  //     break;
  //   default:
  //     print("Invalid operator! Please enter one of (AND, OR).");
  // }
  ...
  // String fruitName = stdin.readLineSync()!.toLowerCase();

  // switch (fruitName) {
  //   case "apple":
  //     print("$fruitName is RED in color");
  //     break;
  //   case "orange":
  //     print("$fruitName is ORANGE in color");
  //     break;
  //   case "mango":
  //     print("$fruitName is YELLOW in color");
  //     break;
  //   case "avacado":
  //     print("$fruitName is GREEN in color");
  //     break;
  //   default:
  //     print('Invalid Action');
  // }
  ...
  print('Enter a day :');
  String dayName = stdin.readLineSync()!.toLowerCase();
